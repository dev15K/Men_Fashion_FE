                        ...
                        <form className="col-md-12" method="post">
                            <div className="site-blocks-table">
                                <table className="table table-bordered">
                                    ...
                                    <tr>
                                        <td className="product-thumbnail">
                                            <img src="/assets/clients/images/cloth_2.jpg" alt="Image" className="img-fluid"/>
                                        </td>
                                        <td className="product-name">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="row mb-5">
                                ...
                                <div className="col-md-6">
                                    <button className="btn btn-outline-primary btn-sm btn-block">Continue Shopping
                                    </button>
                                </div>
                            </div>
                            <div className="row">
                        ...
                        <div className="col-md-6 pl-5">
                            <div className="row justify-content-end">
                                <div className="col-md-7">
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <button className="btn btn-primary btn-lg py-3 btn-block">Proceed To Checkout
                                            </button>
                                        </div>
                                    </div>
                                </div>
